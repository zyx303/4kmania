...
#
# Script generated by Vivado on Mon Jun 17 20:25:38 +0800 2024
...
#
# Usage        : music0.sh
#                music0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                music0.sh [-reset_run]
#                music0.sh [-reset_log]
#                music0.sh [-help]
#
...
#                script (type 'music0.sh -help' for more information).
#
...
# script info
echo -e "music0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./music0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.music0 xil_defaultlib.glbl -o music0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./music0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key music0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc music0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./music0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: music0.sh [-help]\n\
Usage: music0.sh [-step]\n\
Usage: music0.sh [-lib_map_path]\n\
Usage: music0.sh [-reset_run]\n\
Usage: music0.sh [-reset_log]\n\
Usage: music0.sh [-keep_index]\n\
Usage: music0.sh [-noclean_files]\n\n\
