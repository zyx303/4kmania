...
#
# Script generated by Vivado on Mon Jun 17 20:32:38 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : box_rom1.sh
...
#
# Usage        : box_rom1.sh
#                box_rom1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                box_rom1.sh [-reset_run]
#                box_rom1.sh [-reset_log]
#                box_rom1.sh [-help]
#
...
#                script (type 'box_rom1.sh -help' for more information).
#
...
# script info
echo -e "box_rom1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./box_rom1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.box_rom1 xil_defaultlib.glbl -o box_rom1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./box_rom1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key box_rom1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc box_rom1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./box_rom1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: box_rom1.sh [-help]\n\
Usage: box_rom1.sh [-step]\n\
Usage: box_rom1.sh [-lib_map_path]\n\
Usage: box_rom1.sh [-reset_run]\n\
Usage: box_rom1.sh [-reset_log]\n\
Usage: box_rom1.sh [-keep_index]\n\
Usage: box_rom1.sh [-noclean_files]\n\n\
