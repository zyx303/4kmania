...
#
# Script generated by Vivado on Thu Jun 13 18:52:30 +0800 2024
...
#
# Usage        : img0.sh
#                img0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                img0.sh [-reset_run]
#                img0.sh [-reset_log]
#                img0.sh [-help]
#
...
#                script (type 'img0.sh -help' for more information).
#
...
# script info
echo -e "img0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./img0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.img0 xil_defaultlib.glbl -o img0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./img0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key img0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc img0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./img0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: img0.sh [-help]\n\
Usage: img0.sh [-step]\n\
Usage: img0.sh [-lib_map_path]\n\
Usage: img0.sh [-reset_run]\n\
Usage: img0.sh [-reset_log]\n\
Usage: img0.sh [-keep_index]\n\
Usage: img0.sh [-noclean_files]\n\n\
